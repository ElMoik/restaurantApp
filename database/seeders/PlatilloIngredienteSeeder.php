...
class PlatilloIngredienteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        PlatilloIngrediente::create(['platillo_id'=> 1, 'ingrediente_id' => 6]);
        PlatilloIngrediente::create(['platillo_id'=> 2, 'ingrediente_id' => 4]);
        PlatilloIngrediente::create(['platillo_id'=> 2, 'ingrediente_id' => 7]);
        ...
        PlatilloIngrediente::create(['platillo_id'=> 4, 'ingrediente_id' => 9]);
        PlatilloIngrediente::create(['platillo_id'=> 5, 'ingrediente_id' => 1]);
        PlatilloIngrediente::create(['platillo_id'=> 5, 'ingrediente_id' => 10]);
        PlatilloIngrediente::create(['platillo_id'=> 6, 'ingrediente_id' => 1]);
        PlatilloIngrediente::create(['platillo_id'=> 6, 'ingrediente_id' => 10]);
        PlatilloIngrediente::create(['platillo_id'=> 6, 'ingrediente_id' => 11]);
    }
}
